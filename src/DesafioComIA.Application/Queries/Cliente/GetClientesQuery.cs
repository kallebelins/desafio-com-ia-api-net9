...
/// <summary>
/// Query para buscar clientes com filtros, paginação e ordenação
/// </summary>
public record GetClientesQuery : IMediatorQuery<PagedResult<ClienteListDto>>
{
    /// <summary>
    ...
    /// <summary>
    /// Filtro por CPF (busca exata, aceita com/sem formatação)
    /// </summary>
    public string? Cpf { get; init; }

    /// <summary>
    /// Filtro por email (busca exata, case-insensitive)
    /// </summary>
